...
const DESCRIPTION =
  "Esports API pricing with no sales call: free Sandbox for CS2 props, Hobby $29/mo, Builder $99/mo, Pro $199/mo. Transparent plans for DFS props, odds, and match data."

const FAQS = [
  {
    q: "How much does an esports API cost?",
    a: "KashRock publishes flat rates: Sandbox $0, Hobby $29/mo, Builder $99/mo, Pro $199/mo. No enterprise quote required to see the number.",
  },
  {
        ...
        <RefSection id="choose" title="How to choose a tier">
          <RefBullets
            items={[
              ...
              <>Pro ($199) — max throughput for heavier products</>,
            ]}
          />
          <p className="mt-6">
            Also see the{" "}
