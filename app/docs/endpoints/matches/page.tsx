...
const PREP = {
  source: 'kashrock',
  sport: 'esports_cs2',
  kr_match_id: 'kr_cs2_ence-vs-falcons-force-14-09-2026',
  match_slug: 'ence-vs-falcons-force-14-09-2026',
  team_stats: [{ team: 'ENCE', sample_size: 92, map_winrate: 46.74 }],
  map_pools: [{ team: 'ENCE', maps: [{ map: 'Dust2', pick_rate: 48.6, ban_rate: 4.0, win_rate: 49.8 }] }],
  form: [{ team: 'ENCE', results: ['WIN', 'WIN', 'WIN', 'WIN', 'WIN'] }],
}
...
export default function MatchesPage() {
  return (
    <DocsShell active="matches">
      ...
      <h2 className="text-xl font-semibold text-white mb-4">Match prep (CS2, R6, COD, Valorant &amp; Apex)</h2>
      <p className="text-zinc-400 mb-4">
        Team stats, mode winrates, map pool/biases, form, key player matchups, and betting insights for CS2, R6, COD, Valorant, and Apex. Pass a KashRock{' '}
      ...
      <Route path="/v6/esports/{sport}/matches/{match_slug}/prep" />
      <Params rows={[
        { name: 'match_slug', type: 'path', required: true, note: 'KR slug or kr_match_id (not provider ids)' },
      ...
      <Curl path="/v6/esports/cs2/matches/ence-vs-falcons-force-14-09-2026/prep" />
      ...
      <Curl path="/v6/esports/cs2/matches/ence-vs-falcons-force-14-09-2026/player-board" />
      ...
      <p className="text-zinc-400 mb-4">
        Map picks/bans and side winrates for the match&apos;s tournament. Same KashRock match ref as prep.
      </p>
      <Route path="/v6/esports/cs2/matches/{match_slug}/tournament-maps" />
      <Curl path="/v6/esports/cs2/matches/ence-vs-falcons-force-14-09-2026/tournament-maps" />
