...
const ROUTES: { path: string; note: string }[] = [
  ...
  { path: 'GET /v6/esports/{sport}/live/odds', note: 'Matches with real-time shifting betting odds (live & prematch). status=all|live|prematch. Builder plan.' },
  { path: 'GET /v6/esports/{sport}/live/{game_id}/odds', note: 'Shifting betting odds, consensus, and multi-book breakdown for a match. Builder plan.' },
  { path: 'GET /v6/esports/{sport}/live/{game_id}/odds/history', note: 'Audit log tape of odds movements and steam shifts for a match. Builder plan.' },
  { path: 'WS /v6/esports/live/ws', note: 'Push live boxscore/frame/events/odds ticks. Builder+. ?api_key= or Bearer.' },
  ...
  { path: 'GET /v6/esports/{sport}/players/{id}', note: 'Profile by nickname or kr_pl_*.' },
  ...
  { path: 'GET /v6/esports/{sport}/matches/{match_slug}/prep', note: 'Match prep: team stats, map pool/biases, key player matchups, betting insights. CS2 & R6. KashRock slug / kr_match_id only. Builder plan.' },
