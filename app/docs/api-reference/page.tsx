...
const ROUTES: { path: string; note: string }[] = [
  ...
  { path: 'GET /v6/esports/cs2/matches/{match_slug}/prep', note: 'CS2 team stats, map pool, form, H2H. Slug or numeric match id. Builder plan.' },
  { path: 'GET /v6/esports/cs2/matches/{match_slug}/player-board', note: 'CS2 player averages + favourite weapons. Builder plan.' },
  { path: 'GET /v6/esports/cs2/tournaments/{tournament_id}/maps', note: 'CS2 tournament map picks/bans + T/CT winrates + teams. Builder plan.' },
